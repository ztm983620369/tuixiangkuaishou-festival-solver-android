...
public class mySQLite {
	...
	private static boolean checkDataBase() {
		...
		String databaseFilename = getDatabasePath() + dbName;
		// 要自己加上try catch方法
		try {
			// 返回最新的数据库
...
//	}
	...
	public boolean openDataBase() {
		try {
			...
			mSDB = SQLiteDatabase.openOrCreateDatabase(getDatabasePath() + dbName, null);
			return mSDB != null;
		} catch (Exception e) {
			return false;
		}
	...
	private static String getDatabasePath() {
		return myMaps.sRoot + myMaps.sPath + "DataBase/";
	}
