...
void set_log_deadlock_cache()
{
	...
	if (cores_num == 1) log_deadlock_cache = 16 + extra_mem;
	if (cores_num == 2) log_deadlock_cache = 17 + extra_mem;
	if (cores_num == 4) log_deadlock_cache = 18 + extra_mem;
	if (cores_num == 8) log_deadlock_cache = 19 + extra_mem;
#else
